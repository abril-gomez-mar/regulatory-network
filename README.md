...
Para conservar el nombre del archivo donde se reportaron los outputs obtenidos con las dos versiones previas del programa (`test_cases.md`), se creó el documento `tests.md`. Én él se registraron los resultados tras correr la versión más reciente del código.